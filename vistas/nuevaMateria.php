<html>
	...
	$conn->close();
				...
				?>
						...
						<textarea id="desc" cols="51" rows="5" name="descripcion" placeholder="Inserte descripcion" maxlength="255"></textarea>
		...
		<button id="env" type="submit" value="Submit">Enviar</button>
